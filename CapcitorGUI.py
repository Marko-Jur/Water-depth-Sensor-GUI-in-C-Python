...
def osciliscopeGraph():
    ...
    def data_gen():
        ...
        while True:
            t+=1
            dataValRaw = putty.readline()
    
            dataVal = int(dataValRaw.decode().replace("\r\n","\n"))
            #print(dataVal)


            if (dataVal == 98 or dataVal == 97):
                GRAPHPERIOD = 3.5
                
                if (COUNT == 1):
                    compareTime = time.time()
                    compareTime = compareTime - baseSecs
                    print(compareTime)
                    
                    yield t, 1

                    if (compareTime > GRAPHPERIOD):
                        COUNT = 0   
                        baseSecs = time.time()
                else:
                    compareTime = time.time()
                    ...
                    print("compare time: ", compareTime)
                    yield t, 0  
...
def capacitorCheck():
    ...
    while 1:
        ...
        cap2Label = Label(window,text = 'nF', width =4,height = 4, background = 'white', fg = 'black', font = ("MS Sans Serif", 48))
        cap2Label.place(x = 950, y = 420)

        capValLabel = Label(window,textvariable = a, width = 4,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 96) )
        capValLabel.place(x = 600, y = 500)
        capValLabel.config(text=str(a))
        window.update()

        #Done
        doneButton = Button(window,text="done",wid2th = 16, background = BUTTONCOLOUR, fg = 'black',  activebackground = BUTTONCOLOURFLASH, command = ser.close())
        doneButton.place(x=2,y=40)
...
def rainCheck():
    ...
    rainLabel = Label(window,text = 'RAINLEVEL:', width = 15,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 48), underline = 10)
    rainLabel.place(x = 450, y = 300)

    rain1ValLabel = Label(window,text = '4cm', width = 4,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 48) )
    rain1ValLabel.place(x = 410, y = 700)

    rain2ValLabel = Label(window,text = '8cm', width = 4,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 48) )
    rain2ValLabel.place(x = 410, y = 550)

    rain3ValLabel = Label(window,text = '12cm', width = 4,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 48) )
    rain3ValLabel.place(x = 410, y = 400)
    
    #rain4ValLabel = Label(window,text = '12cm', width = 4,height = 1, background = 'white', fg = 'black', font = ("MS Sans Serif", 48) )
    #rain4ValLabel.place(x = 410, y = 400)
    ...
    while 1:
        ...
        if (rainVal == 4):
            rainValLabel = Label(window, width = 8,height = 1, background = 'blue', fg = 'black', font = ("MS Sans Serif", 48) )
            rainValLabel.place(x = 580, y = 700)
            window.update()
          
        elif (rainVal == 8):
            rainVal2Label = Label(window, width = 8,height = 1, background = 'blue', fg = 'black', font = ("MS Sans Serif", 48) )
            rainVal2Label.place(x = 580, y = 550)
            window.update()

        elif (rainVal == 12):
            rainVal4Label = Label(window, width = 8,height = 1, background = 'blue', fg = 'black', font = ("MS Sans Serif", 48) )
            rainVal4Label.place(x = 580, y = 400)
            window.update()
            ser.close()
            RAINLEVEL = 12
            x = sendWaterSMS()
...
def sendWaterSMS():
    ...
    RAINLEVEL = str(RAINLEVEL)
    # change the "from_" number to your Twilio number and the "to" number
    # to the phone number you signed up for Twilio with, or upgrade your
    # account to send SMS to any phone number
    client.messages.create(to=USERNUMBER, 
                        from_="+17316024317", 
                        body="Hello " + USERNAME + "Your water level is " + RAINLEVEL + 'cm')
###################################################################################################################################################################
def sendTestSMS():
    global USERNUMBER
    global USERNAME
...
def mainMenu():
    #Clearing screen
    mainScreenCoverup = Label(window,width = 1600, height = 1600, background = 'white')
    mainScreenCoverup.place(x = 0,y = 300)
